...
# Bagging model
model11_test = BaggingClassifier(estimator=logistic_regression)
...
print(params)
gridsearch = GridSearchCV(model11_test, param_grid=params, cv=3, scoring='f1', verbose=3)
...
model11_details = {
    ...
    'Model_Type' : 'Bagging - LogisticRegression',
    'Multivariate' : 'Yes',
    ...
    'Hyperparameter_C' : gridsearch.best_params_["estimator__C"],
