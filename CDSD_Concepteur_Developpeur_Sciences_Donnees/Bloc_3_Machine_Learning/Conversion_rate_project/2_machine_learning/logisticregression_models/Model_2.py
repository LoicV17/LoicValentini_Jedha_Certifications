...
from preprocessings.Preprocessing_2 import (
...
with mlflow.start_run(run_name="model2"):
    ...
    mlflow.log_param("preprocessing", "preprocessing_2")
    mlflow.log_param("features", "age, country, new_user, total_pages_visited")
