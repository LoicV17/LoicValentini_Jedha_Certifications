...
MODEL_DIR = os.path.join(BASE_DIR, "models", "1_skindisease_mobilenetv2_original")
...
base_model.trainable = False  # non finetuné
...
# 📌 Callbacks
checkpoint_path = os.path.join(MODEL_DIR, "model1_best_model.h5")
callbacks = [
...
plot_history("accuracy", "Accuracy Evolution")
plot_history("loss", "Loss Evolution")
...
print("✅ Modèle entraîné et évalué. Résultats sauvegardés dans :")
print(MODEL_DIR)
