...
# Callbacks
checkpoint_path = os.path.join(output_dir, "model8_bestmodel.h5")
callbacks = [
...
plt.legend()
plt.title("Accuracy")
plt.savefig(os.path.join(output_dir, "model8_accuracy.png"))
...
plt.legend()
plt.title("Loss")
plt.savefig(os.path.join(output_dir, "model8_loss.png"))
...
with open(os.path.join(output_dir, "model8_classification_report.txt"), "w") as f:
    f.write(report)
...
plt.savefig(os.path.join(output_dir, "model8_confusion_matrix_percent.png"))
