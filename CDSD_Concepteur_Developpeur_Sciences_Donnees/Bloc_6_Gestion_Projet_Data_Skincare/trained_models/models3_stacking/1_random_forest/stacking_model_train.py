...
MODEL_PATH = os.path.join(BASE_DIR, "trained_models\c", "7_ham10000_efficientnetb0_finetuned", "model7_bestmodel.h5")
STACKING_DIR = os.path.join(BASE_DIR, "trained_models", "stacking_model")
